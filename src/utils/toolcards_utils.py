#!/usr/bin/env python3
"""Toolcards cache loading helpers for registry commands."""
...
def load_toolcards(
    ...
    """Load toolcard records from the active cache snapshot."""
    ...
    artifact_path = find_single_artifact_path(
        ...
        artifact_prefix="toolcards",
        fail=fail,
    )
    return load_object_records(artifact_path, "toolcards artifact", fail)
